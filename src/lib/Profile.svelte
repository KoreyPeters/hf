...
<div class="container">
	...
	<form use:getProfile on:submit|preventDefault={updateProfile}>
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input id="username" type="text" bind:value={$username} class="form-control" />
			</div>
		</div>
		<div class="row mb-3">
			<label for="website" class="col-sm-2 col-form-label">Website</label>
			<div class="col-sm-10">
				<input id="website" type="website" bind:value={website} class="form-control" />
			</div>
		</div>
	...
	<a href="/users/{supabase.auth.user().id}" class="btn btn-primary"
		>Show your QR Code to attend an event</a
	>
